...
describe('Client Service', () => {
    ...
    describe('createClient', () => {
        ...
        it('should create a client successfully', async () => {
            ...
            const result = await clientService.createClient('Test Client', ['ACC-001', 'ACC-002'], 'John Doe', 'active');
    ...
    describe('updateClientById', () => {
        ...
        it('should throw ApiError if client not found', async () => {
            ...
            await expect(clientService.updateClientById('nonexistent-client', updateBody)).rejects.toThrow(new ApiError(httpStatus.NOT_FOUND, 'Client not found'));
        });
    });
    describe('deleteClientById', () => {
        ...
        it('should throw ApiError if client not found', async () => {
            mockPrismaClient.client.findUnique.mockResolvedValue(null);
            await expect(clientService.deleteClientById('nonexistent-client')).rejects.toThrow(new ApiError(httpStatus.NOT_FOUND, 'Client not found'));
        });
    });
    describe('queryClients', () => {
        ...
        it('should query clients with custom options', async () => {
            ...
            const options = { page: 2, limit: 5, sortBy: 'name', sortType: 'asc' };
