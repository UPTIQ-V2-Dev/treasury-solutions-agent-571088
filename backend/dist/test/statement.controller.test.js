...
describe('Statement Controller', () => {
    ...
    describe('uploadStatement', () => {
        test('should upload statement successfully', async () => {
            ...
            statementService.uploadStatementFile.mockResolvedValue(mockStatementFile);
        ...
        test('should handle service error', async () => {
            ...
            statementService.uploadStatementFile.mockRejectedValue(error);
            try {
                await statementController.uploadStatement(req, res, next);
            }
            catch (thrownError) {
    ...
    describe('getUploadStatus', () => {
        test('should get upload status successfully', async () => {
            ...
            statementService.getUploadStatus.mockResolvedValue(mockStatus);
        ...
        test('should throw error if upload not found', async () => {
            ...
            try {
                ...
                expect(thrownError.statusCode).toBe(httpStatus.NOT_FOUND);
            }
        });
    });
    describe('parseStatement', () => {
        test('should parse statement successfully', async () => {
            ...
            statementService.parseStatement.mockResolvedValue(mockParseResult);
    ...
    describe('getStatementFiles', () => {
        test('should get statement files successfully', async () => {
            ...
            statementService.queryStatementFiles.mockResolvedValue(mockStatementFiles);
    ...
    describe('generateUploadUrl', () => {
        test('should generate upload URL successfully', async () => {
            ...
            req.params = { id: 'statement1' };
            statementService.generateUploadSignedUrl.mockResolvedValue(mockUploadUrl);
    ...
    describe('updateUploadStatus', () => {
        test('should update upload status successfully', async () => {
            ...
            statementService.updateStatementFileStatus.mockResolvedValue(mockStatementFile);
