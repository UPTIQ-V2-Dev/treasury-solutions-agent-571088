...
describe('Dashboard Tools', () => {
    ...
    describe('getDashboardMetricsTool', () => {
        ...
        it('should have correct tool configuration', () => {
            ...
            expect(getDashboardMetricsTool.description).toBe('Get comprehensive dashboard overview metrics including client counts, analyses, recommendations, potential savings, recent activity, and top opportunities');
        });
