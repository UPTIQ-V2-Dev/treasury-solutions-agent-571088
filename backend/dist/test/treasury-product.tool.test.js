...
import { treasuryProductTools } from "../tools/treasury-product.tool.js";
...
describe('Treasury Product Tools', () => {
    ...
    describe('treasury_product_get_all tool', () => {
        ...
        it('should exist and have correct properties', () => {
            ...
            expect(getTreasuryProductsTool?.description).toBe('Get all available treasury products with optional filtering');
        });
    ...
    describe('treasury_product_get_by_id tool', () => {
        ...
        it('should throw error if product not found', async () => {
            ...
            await expect(getTreasuryProductTool.fn({ productId: 'nonexistent' })).rejects.toThrow('Treasury product not found');
        });
        it('should validate input schema', () => {
    ...
    describe('treasury_product_get_by_category tool', () => {
        const getTreasuryProductsByCategoryTool = treasuryProductTools.find(tool => tool.id === 'treasury_product_get_by_category');
        ...
        it('should exist and have correct properties', () => {
            ...
            expect(getTreasuryProductsByCategoryTool?.description).toBe('Get all active treasury products in a specific category');
        });
    ...
    describe('treasury_product_get_active tool', () => {
        const getActiveTreasuryProductsTool = treasuryProductTools.find(tool => tool.id === 'treasury_product_get_active');
