...
describe('Analysis Tools', () => {
    ...
    describe('analysis_get tool', () => {
        ...
        it('should throw error when analysis not found', async () => {
            ...
            await expect(getTool.fn({ analysisId: 'invalid-analysis' })).rejects.toThrow('Analysis not found with ID: invalid-analysis');
        });
    });
    describe('analysis_get_transactions tool', () => {
        ...
        it('should handle service errors', async () => {
            ...
            await expect(getTransactionsTool.fn({ analysisId: 'invalid-analysis' })).rejects.toThrow('Analysis not found');
        });
    });
    describe('analysis_query tool', () => {
        ...
        it('should handle filter parameters', async () => {
            ...
            expect(result).toEqual({ analyses: mockAnalyses });
            expect(analysisService.queryAnalyses).toHaveBeenCalledWith({ clientId: 'client-1', status: 'completed' }, { sortBy: 'createdAt', limit: 10, page: 1 });
        });
