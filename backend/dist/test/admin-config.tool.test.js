...
import { adminConfigTools } from "../tools/admin-config.tool.js";
...
describe('Admin Config Tools', () => {
    ...
    describe('updateConfigurationTool', () => {
        it('should update system configuration', async () => {
            ...
            expect(mockAdminConfigService.updateConfiguration).toHaveBeenCalledWith({ thresholds: { idleCashThreshold: 150000 } }, 'admin@example.com');
        });
