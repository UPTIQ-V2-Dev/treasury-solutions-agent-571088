...
async function main() {
    ...
    console.log('✅ Created sample treasury products:', product1.name, product2.name, product3.name, product4.name, product5.name, product6.name);
    ...
    const recommendation1 = await prisma.recommendation.upsert({
        ...
        create: {
            ...
            priority: 'high',
            rationale: 'Client maintains average idle balances of $185,000 for 22 days per month, well above the sweep threshold',
            dataPoints: [
    ...
    const recommendation2 = await prisma.recommendation.upsert({
        ...
        create: {
            ...
            priority: 'medium',
            rationale: 'Multiple account structure with significant cash flows could benefit from centralized management',
            dataPoints: [
