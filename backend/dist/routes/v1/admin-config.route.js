import { adminConfigController } from "../../controllers/index.js";
import auth from "../../middlewares/auth.js";
import validate from "../../middlewares/validate.js";
import { adminConfigValidation } from "../../validations/index.js";
import express from 'express';
const router = express.Router();
// Admin configuration routes
router
    .route('/config')
    .get(auth('getAdminConfig'), validate(adminConfigValidation.getConfiguration), adminConfigController.getConfiguration)
    .put(auth('manageAdminConfig'), validate(adminConfigValidation.updateConfiguration), adminConfigController.updateConfiguration);
router
    .route('/config/reset')
    .post(auth('manageAdminConfig'), validate(adminConfigValidation.resetConfiguration), adminConfigController.resetConfiguration);
