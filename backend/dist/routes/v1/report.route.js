...
import { reportValidation } from "../../validations/index.js";
 ...
 */
router.post('/generate', auth('generateReports'), validate(reportValidation.generateReport), reportController.generateReport);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.get('/download/:reportId', auth('downloadReports'), validate(reportValidation.downloadReport), reportController.downloadReport);
/**
 * @swagger
 * /reports/history:
 *   get:
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.delete('/:reportId', auth('deleteReports'), validate(reportValidation.deleteReport), reportController.deleteReport);
