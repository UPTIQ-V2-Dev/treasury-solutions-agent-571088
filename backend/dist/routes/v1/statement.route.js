import { analysisController, statementController } from "../../controllers/index.js";
import auth from "../../middlewares/auth.js";
import validate from "../../middlewares/validate.js";
import { analysisValidation, statementValidation } from "../../validations/index.js";
...
router
    .route('/analyze')
    .post(auth('manageStatements'), validate(analysisValidation.analyzeStatements), analysisController.analyzeStatements);
...
router
    ...
    .delete(auth('manageStatements'), validate(statementValidation.deleteStatementFile), statementController.deleteStatementFile);
router
    .route('/:id/upload-url')
    .get(auth('manageStatements'), validate(statementValidation.generateUploadUrl), statementController.generateUploadUrl);
