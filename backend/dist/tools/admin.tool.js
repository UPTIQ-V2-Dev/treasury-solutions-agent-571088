...
export const getSystemConfigTool = {
...
export const updateSystemConfigTool = {
...
export const resetSystemConfigTool = {
...
export const exportAuditLogsTool = {
...
export const createAuditEntryTool = {
...
export async function handleAdminToolCall(name, args) {
    switch (name) {
        ...
        case 'export_audit_logs':
            ...
            if (exportFilter.dateFrom)
                exportFilter.dateFrom = new Date(exportFilter.dateFrom);
            if (exportFilter.dateTo)
                exportFilter.dateTo = new Date(exportFilter.dateTo);
