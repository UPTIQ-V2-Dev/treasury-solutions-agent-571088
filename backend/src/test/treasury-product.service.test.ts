...
import treasuryProductService from '../services/treasury-product.service.ts';
...
const mockPrismaTreasuryProduct = prisma as any;
...
describe('Treasury Product Service', () => {
    ...
    describe('queryTreasuryProducts', () => {
        ...
        it('should return products with custom options', async () => {
            ...
            const options = { page: 2, limit: 10, sortBy: 'category', sortType: 'desc' as const };
