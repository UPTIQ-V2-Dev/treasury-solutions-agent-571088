...
describe('Dashboard Service', () => {
    ...
    describe('getDashboardMetrics', () => {
        ...
        it('should handle database errors gracefully', async () => {
            ...
            await expect(dashboardService.getDashboardMetrics()).rejects.toThrow(
                new ApiError(httpStatus.INTERNAL_SERVER_ERROR, `Failed to fetch dashboard metrics: ${errorMessage}`)
            );
        });
