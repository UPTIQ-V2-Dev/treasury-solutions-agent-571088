...
describe('Statement Tools', () => {
    ...
    describe('uploadStatementTool', () => {
        ...
        test('should call service and return result', async () => {
            ...
            (statementService.uploadStatementFile as any).mockResolvedValue(mockResult);
    ...
    describe('getUploadStatusTool', () => {
        ...
        test('should call service and return result', async () => {
            ...
            (statementService.getUploadStatus as any).mockResolvedValue(mockResult);
    ...
    describe('parseStatementTool', () => {
        ...
        test('should call service and return result', async () => {
            ...
            (statementService.parseStatement as any).mockResolvedValue(mockResult);
    ...
    describe('getStatementFilesTool', () => {
        ...
        test('should call service with picked parameters', async () => {
            ...
            (statementService.queryStatementFiles as any).mockResolvedValue(mockResult);
    ...
    describe('generateUploadUrlTool', () => {
        ...
        test('should call service and return URL', async () => {
            ...
            (statementService.generateUploadSignedUrl as any).mockResolvedValue(mockResult);
