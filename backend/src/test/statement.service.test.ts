...
describe('Statement Service', () => {
    ...
    describe('uploadStatementFile', () => {
        ...
        test('should throw error if client not found', async () => {
            ...
            await expect(statementService.uploadStatementFile(fileData)).rejects.toThrow(
        ...
        test('should throw error for invalid file type', async () => {
            ...
            await expect(statementService.uploadStatementFile(fileData)).rejects.toThrow(
                new ApiError(httpStatus.BAD_REQUEST, 'Invalid file type. Supported types: PDF, CSV, XLS, XLSX')
            );
        });
        ...
        test('should throw error for file too large', async () => {
            ...
            await expect(statementService.uploadStatementFile(fileData)).rejects.toThrow(
                new ApiError(httpStatus.BAD_REQUEST, 'File too large. Maximum size is 50MB')
            );
        });
    });
...
2024-01-16,Deposit,200.00,1200.00`;
        ...
        test('should throw error if statement file not found', async () => {
            ...
            await expect(statementService.parseStatement('nonexistent')).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'Statement file not found')
            );
        });
        ...
        test('should throw error if file not uploaded', async () => {
            ...
            await expect(statementService.parseStatement('statement1')).rejects.toThrow(
                new ApiError(httpStatus.BAD_REQUEST, 'File must be successfully uploaded before parsing')
            );
        });
        ...
        test('should throw error if already parsed', async () => {
            ...
            await expect(statementService.parseStatement('statement1')).rejects.toThrow(
                new ApiError(httpStatus.BAD_REQUEST, 'Statement file has already been parsed')
            );
        });
    });
    ...
    describe('queryStatementFiles', () => {
        test('should query statement files successfully', async () => {
            ...
            const options = { limit: 10, page: 1, sortBy: 'uploadedAt', sortType: 'desc' as const };
    ...
    describe('deleteStatementFileById', () => {
        ...
        test('should throw error if statement file not found', async () => {
            ...
            await expect(statementService.deleteStatementFileById('nonexistent')).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'Statement file not found')
            );
        });
    });
    ...
    describe('generateUploadSignedUrl', () => {
        ...
        test('should throw error if statement file not found', async () => {
            ...
            await expect(statementService.generateUploadSignedUrl('nonexistent')).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'Statement file not found')
            );
        });
    });
