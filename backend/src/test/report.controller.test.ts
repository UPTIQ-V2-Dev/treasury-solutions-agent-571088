...
describe('Report Controller', () => {
    ...
    describe('POST /reports/generate', () => {
        ...
        it('should handle service errors', async () => {
            (reportService.generateReport as MockedFunction<any>).mockRejectedValue(new Error('Service error'));
    ...
    describe('GET /reports/download/:reportId', () => {
        it('should download report successfully', async () => {
            ...
            (reportService.getReportDownloadStream as MockedFunction<any>).mockResolvedValue({
                stream: mockStream,
        ...
        it('should handle service errors during download', async () => {
            (reportService.getReportDownloadStream as MockedFunction<any>).mockRejectedValue(
