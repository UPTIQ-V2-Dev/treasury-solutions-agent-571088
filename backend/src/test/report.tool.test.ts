...
describe('Report MCP Tools', () => {
    let generateReportTool: any;
    let getReportTool: any;
    let queryReportsTool: any;
    let deleteReportTool: any;
    let getTemplatesTool: any;
    let getTemplateTool: any;
    ...
    describe('generateReportTool', () => {
        it('should generate a report successfully', async () => {
            (reportService.generateReport as MockedFunction<any>).mockResolvedValue(mockReport);
        ...
        it('should propagate service errors', async () => {
            (reportService.generateReport as MockedFunction<any>).mockRejectedValue(new Error('Generation failed'));
    ...
    describe('getReportTool', () => {
        it('should get report successfully', async () => {
            (reportService.getReportById as MockedFunction<any>).mockResolvedValue(mockReport);
        ...
        it('should throw error when report not found', async () => {
            (reportService.getReportById as MockedFunction<any>).mockResolvedValue(null);
    ...
    describe('queryReportsTool', () => {
        it('should query reports successfully', async () => {
            (reportService.queryReports as MockedFunction<any>).mockResolvedValue(mockReportsResponse);
    ...
    describe('deleteReportTool', () => {
        it('should delete report successfully', async () => {
            (reportService.deleteReportById as MockedFunction<any>).mockResolvedValue(mockReport);
        ...
        it('should propagate service errors', async () => {
            (reportService.deleteReportById as MockedFunction<any>).mockRejectedValue(new Error('Deletion failed'));
    ...
    describe('getTemplatesTool', () => {
        it('should get all templates successfully', async () => {
            ...
            (reportService.getTemplates as MockedFunction<any>).mockReturnValue(mockTemplates);
        ...
        it('should handle empty template list', async () => {
            (reportService.getTemplates as MockedFunction<any>).mockReturnValue([]);
    ...
    describe('getTemplateTool', () => {
        it('should get template by ID successfully', async () => {
            (reportService.getTemplate as MockedFunction<any>).mockReturnValue(mockTemplate);
        ...
        it('should return null when template not found', async () => {
            (reportService.getTemplate as MockedFunction<any>).mockReturnValue(null);
