...
import recommendationValidation from '../../validations/recommendation.validation.ts';
...
router
    ...
    .post(
        auth('manageAnalysis'),
        validate(recommendationValidation.generateRecommendations),
...
router
    ...
    .get(
        auth('getAnalysis'),
        validate(recommendationValidation.getRecommendation),
...
router
    ...
    .put(
        auth('manageAnalysis'),
        validate(recommendationValidation.approveRecommendation),
...
router
    ...
    .put(
        auth('manageAnalysis'),
        validate(recommendationValidation.rejectRecommendation),
