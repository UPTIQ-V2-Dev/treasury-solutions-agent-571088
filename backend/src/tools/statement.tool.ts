...
const uploadStatementTool: MCPTool = {
    id: 'statement_upload',
    ...
    fn: async (inputs: { filename: string; type: string; size: number; clientId: string }) => {
        const statementFile = await statementService.uploadStatementFile(inputs);
        return statementFile;
    }
};

const getUploadStatusTool: MCPTool = {
    ...
    fn: async (inputs: { uploadId: string }) => {
...
const parseStatementTool: MCPTool = {
    id: 'statement_parse',
...
const getStatementFileTool: MCPTool = {
...
const deleteStatementFileTool: MCPTool = {
...
const generateUploadUrlTool: MCPTool = {
